      ...
      <div className="w-full max-w-md bg-gray-800 p-6 rounded-lg shadow-xl">
        ...
        <div className="flex items-center gap-2 mb-4">
          <input
            ...
            className="flex-1 p-3 text-sm rounded-md border border-gray-600 bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
